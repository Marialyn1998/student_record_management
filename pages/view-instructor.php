...
if (! (isset ( $_SESSION ['login'] ))) {
    ...
    $obj=new DbFunction();
    $rs=$obj->showinstructor_register();
   

    if(isset($_GET['del']))
    {    
         
          $obj->del_instructor_register(intval($_GET['del']));
    }
...
<body>
    ...
    <div id="wrapper">
     ...
     <?php include('leftbar.php')?>;
      ...
      <td>&nbsp;&nbsp;<a href="edit-instructor.php?id=<?php echo htmlentities($res->id);?>">
      <p class="fa fa-edit"></p></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <a href="view-instructor.php?del=<?php echo htmlentities($res->id); ?>">

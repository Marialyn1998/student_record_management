...
if (! (isset ( $_SESSION ['login'] ))) {
  ...
  if(isset($_POST['submit'])){
	...
	$obj->create_instructor($_POST['fullname'],$_POST['spelization'],$_POST['sub1'],$_POST['sub2'],$_POST['sub3']);	
...
<form method="post" >
	<div id="wrapper">
		...
		<div class="form-group">
		<div class="col-lg-4">
		<label>spelization<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">

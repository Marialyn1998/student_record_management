...
<form method="post" >
	...
	<?php include('leftbar.php');?>
		...
		<div id="page-wrapper">
		    ...
		    <div class="col-lg-4">
			<label>Select Instructor Course<span id="" style="font-size:11px;color:red">*</span>	</label>
			</div>
			<div class="col-lg-6">
...
<option VALUE="">SELECT</option>
		...
		<div class="form-group">
		<div class="col-lg-4">
		<label>Select Instructor Subject<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
...
<option VALUE="">Select Country</option>
 ...
 <select name="state" id="state"  class="form-control" onchange="showDist(this.value)" required="required">
	...
	<br><br><br><br>		
			...
			<div class="col-lg-4">
           <select name="city" id="dist"  class="form-control" onchange="showDist(this.value) required="required">

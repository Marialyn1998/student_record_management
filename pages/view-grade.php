                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php 
                                     ...
                                     while($res=$rs->fetch_object()){?>	
                                        <tr class="odd gradeX">
                                            <td><?php echo $sn?></td>
                                            <td><?php echo htmlentities( strtoupper($res->gradeid));?></td>
                                        
                                            <td><?php echo htmlentities( strtoupper($res->subject));?></td>
                                            <td><?php echo htmlentities(strtoupper($res->grades));?></td>

                                            <td>&nbsp;&nbsp;<a href="edit-grade.php?sid=<?php echo htmlentities($res->subid);?>"><p class="fa fa-edit"></p></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
